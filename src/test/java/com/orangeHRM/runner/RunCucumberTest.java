...
@CucumberOptions(plugin = {"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:",
		"rerun:report/rerun.txt"}, features= "src/test/resources/FA_Regression_Suite/OrangeHRM", 
		glue= "com.orangeHRM.stepdefs", tags= "@AdeshK" )

/*@CucumberOptions(plugin = {"pretty","html:target/cucumber-reports",
"rerun:report/rerun.txt"}, features= "src/test/resources/FA_Regression_Suite/OrangeHRM", 
glue= "com.orangeHRM.stepdefs", tags= "@AdeshK", publish=true)*/
