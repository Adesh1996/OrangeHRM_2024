...
/**
 * This class creates handles the class of methods of custom
 * webelements.
 **/
...
public class CustomElementLocator implements MethodInterceptor {
	 ...
	 * 
	 * @param locator
	 * 				The locator to get the webelement from webpage.
	 * 
	 **/
	...
	public Object intercept(Object o, Method method, Object[] objects, MethodProxy methodProxy) throws Throwable {
		...
		//should have be called in the current usecase because it gets handled
		//in the CustomElementFieldDecorator class
	 ...
	 * 
	 * @return 
	 * 			Returns a proxy element which implements the webelement. This is 
	...
	/**
	 * Creates a dynamic proxy element for a webelement. Stolen from the 
	 * DefaultFieldDecorator.class class in th selenium lib. Further information on
	 * 
	 * @param loader
