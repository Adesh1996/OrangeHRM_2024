...
public abstract class CustomWebElement {
	...
	public CustomWebElement(WebDriver webDriver, By by) {
		...
		//Call the page factory on this object to initialize custom webelements.
		//in custom webelements (aka nesting)
	...
	/**
	 * The element must be visible in order to retrieve its attribute. Get the value
	 * of a the given attribute of the element. Will return the current value, even
	 * if this has been modified after the page has been loaded. More exactly, this
	 * method will return the value of the given attribute, unless that attribute is
	 * not present, in which case the value of the property with the same name is
	 * returned (for example for the "value" property of a textarea element).If
	 * neither value is set, null is returned. The "style" attribute is converted as
	 * best can be to a text representation with a trailing semi-colon. The
	 * following are deemed to be "boolean" attributes, and will return either
	 * "true" or null:
	 * <p>
	 * async, autofocus, autoplay, checked, compact, complete, controls, declare,
	 * defaultchecked, defaultselected, defer, disabled, draggable, ended,
	 * formnovalidate, hidden, indeterminate, iscontenteditable, ismap, nowrap,
	 * open, paused, pubdate, readonly, required, reversed, scoped, seamless,
	 * seeking, selected, spellcheck, truespeed, eillvalidate
	 * <p>
